...
import org.usfirst.frc.team3176.robot.Constants;
...
public class Drivetrain extends Subsystem {
	...
	private AHRS gyro;
<<<<<<< HEAD:StuartDev/src/main/java/Subsystem/Drivetrain.java
	//private Kinematics kinematics;
=======
//	private Kinematics kinematics;
>>>>>>> 74fda81fdce63cec63fcb22401b559351ba9a2e7:StuartDev/VSCode/VisionAndX/src/main/java/Subsystem/Drivetrain.java
			...
			switch(currentState) {
				...
				case VISION:
					...
					//if(!Intake.getInstance().isCubeIn()) {
						spinCommand = pidRotate.returnOutput(Double.parseDouble(cam.getXCoord()), 160);
