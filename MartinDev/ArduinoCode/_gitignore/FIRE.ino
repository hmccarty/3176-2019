...
void setup() {
  ...
  //gPal = CRGBPalette16( CRGB::Black, CRGB::DarkViolet, CRGB::DarkMagenta, CRGB::White);
...
void loop()
{
  ...
  //   gPal = CRGBPalette16( CRGB::DarkViolet, darkcolor, lightcolor, CRGB::Purple);
...
void runFire() {
  ...
  else if (Fire == 2)
  {
    ...
    gPal = CRGBPalette16( CRGB::Black, CRGB::Navy, CRGB::Blue, CRGB::Azure);
  }
}
